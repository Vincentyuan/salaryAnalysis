...
java -cp /usr/local/lib/sample-java-elasticsearch-client-jar-with-dependencies.jar main.ElasticInitial

curl -XPUT 'localhost:9200/.kibana/_settings' -d '{ "index" : { "number_of_replicas" : 0 } }'
curl -XPUT 'localhost:9200/sf/_settings' -d '{ "index" : { "number_of_replicas" : 0 } }'
